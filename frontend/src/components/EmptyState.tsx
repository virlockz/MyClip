...
export default function EmptyState({ onIngest, onComplete }: Props) {
  return (
    <div className="empty-state">
      ...
      <p className="empty-desc">
        Drag your video and subtitle files below, or use the CLI.
      </p>

      <DropZone onUploadComplete={onComplete} />
